  ...
  return (
    <main className="w-11/12 mx-auto h-full relative">
      <div className="w-[25rem] max-md:w-full mx-auto h-auto relative top-8 bottom-16 bg-white">
        ...
        <p className="text-sm text-gray-500 text-center my-2">By Registering with us you have agreed to out <Link href="/service/privacy-policy" className=" hover:underline">Privacy Policy</Link> and <Link href="/service/terms-and-conditions" className=" hover:underline">Terms and conditions</Link></p>
        <br />
        <br />
      </div>
    </main>
